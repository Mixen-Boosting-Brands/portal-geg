							...
							<div class="swiper-slide">
								<div class="card mb-3" data-aos="fade-right" data-aos-delay="<?php echo $i; ?>00" data-aos-duration="800" data-aos-once="true">
									<a 
										...
										data-bs-cv-id="<?php if( have_rows('datos_del_integrante') ): while( have_rows('datos_del_integrante') ): the_row(); ?><?php if( have_rows('cv') ): while( have_rows('cv') ): the_row(); ?><?php if( get_sub_field('pagina') ): ?><?php echo get_sub_field('pagina'); ?><?php endif; ?><?php endwhile; endif; ?><?php endwhile; endif; ?>"
									>
