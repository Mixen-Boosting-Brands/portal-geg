                ...
                <div class="col">
                    <a href="<?php echo esc_url(home_url()); ?>">
                        <figure>
                            ...
                            ); ?>/assets/images/logo.png" alt="" class="logo img-fluid" data-aos="zoom-in" data-aos-duration="600" data-aos-delay="200" data-aos-once="true">
                        </figure>
                    </a>
                </div>
            </div>
     ...
     endwhile;
                        ...
                        <?php if ($currentlang == "en-US"): ?>
                            <li>
                                <a href="<?php echo get_page_link(
                                    "21"
                                ); ?>"><?php echo get_the_title("21"); ?></a>
                            </li>
                            <li>
                                <a href="<?php echo get_page_link(
                                    "25"
                                ); ?>"><?php echo get_the_title("357"); ?></a>
                            </li>
                        <?php else: ?>
                            <li>
                                <a href="<?php echo get_page_link(
                ...
                <div class="col-lg-4" data-aos="fade-up" data-aos-duration="600" data-aos-delay="800" data-aos-once="true">
                    ...
                    <nav>
                        <ul class="list-unstyled">
                            <li>
                            <?php if ($currentlang == "en-US"): ?>
                                <a href="https://grupogeg.com/en/" class="btn btn-primary"><?php esc_html_e(
                                    "Ingresar",
                                    "geg"
                                ); ?></a>
                            <?php else: ?>
                                <a href="https://grupogeg.com/" class="btn btn-primary"><?php esc_html_e(
                                    "Ingresar",
                                    "geg"
                                ); ?></a>
                            <?php endif; ?>
            ...
            <div class="row">
                <div class="col text-end mt-4">
                    <?php if (
                        $currentlang == "en-US"
                    ): ?><a href="https://grupogeg.com/en/privacy-policy/"><?php esc_html_e(
    "Aviso de Privacidad",
    "geg"
); ?></a><?php else: ?><a href="https://grupogeg.com/aviso-de-privacidad/"><?php esc_html_e(
    "Aviso de Privacidad",
    "geg"
...
?>
    ...
    <script src="<?php echo esc_url(
        get_template_directory_uri()
    ); ?>/assets/js/app.bundle.js?ver=<?php echo rand(111, 999); ?>"></script>
